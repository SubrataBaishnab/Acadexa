...
const registrationRoutes = require('./routes/registrationRoutes'); // Your modular Module 1
...
const supervisorReviewRoutes = require('./routes/supervisorReviewRoutes');
...
app.use('/api/reviews', supervisorReviewRoutes);
